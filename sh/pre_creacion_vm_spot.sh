...
github_install_repo="clouditbac"
...
gcloud compute instances create instance-instalacion \
    ...
    --create-disk=auto-delete=yes,boot=yes,device-name=instance-instalacion,image=projects/ubuntu-os-cloud/global/images/ubuntu-minimal-2404-noble-amd64-v20251020,mode=rw,size=50,type=pd-balanced \
